...
import com.android.picshow.edit.editor.graffti.DialogController;
...
import com.android.picshow.edit.editorui.utils.Constants;
import com.android.picshow.edit.editorui.utils.FragmentUtils;
...
public class EditActivity extends Activity implements View.OnClickListener, View.OnTouchListener {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.edit_enhance:
                addFragment(BaseEditorManager.ENHANCE);
                break;

            case R.id.edit_mosatic:
