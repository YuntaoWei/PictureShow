package com.android.picshow.edit.editor.mosaic;
...
public class MosaicUtil {
    ...
    public static Bitmap getBlur(Bitmap bitmap, int radius) {
        int iterations = 1;
        int width = bitmap.getWidth();
        int height = bitmap.getHeight();
    ...
    public static void drawMosaicPath(Canvas canvas, Path path, Paint paint, int paintWidth) {

    }

    public static void drawEraserPath(Canvas canvas, Path path, Paint paint, int paintWidth) {

    }


    public static void drawPathByType(Canvas canvas, MosaicPath path, Paint p) {
        if(path.pathType == MosaicType.MOSAIC) {
            //draw
            drawMosaicPath(canvas, path.drawPath, p, path.paintWidth);
        } else {
            //clear
            drawEraserPath(canvas, path.drawPath, p, path.paintWidth);
        }
    }
